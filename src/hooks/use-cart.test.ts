...
describe('useCart', () => {
  ...
  it('should add item to cart', () => {
    const product = { id: 1, slug: 'test', name: 'Test Product', price: 100, image: 'img.jpg' };
  ...
  it('should calculate total price correctly', () => {
    useCart.getState().addItem({ id: 1, slug: 'p1', name: 'P1', price: 100, image: 'img.jpg' });
    useCart.getState().addItem({ id: 2, slug: 'p2', name: 'P2', price: 250, image: 'img.jpg' });
