    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-background text-foreground">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-2xl font-bold text-foreground">Акция не найдена</h1>
    ...
    <div className="min-h-screen pb-20 bg-background text-foreground">
      ...
      <div className="bg-muted/30 border-b border-border py-4">
        <div className="container-main flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground/50">
          ...
          <span className="text-muted-foreground truncate max-w-[200px]">{promo.title}</span>
        </div>
      </div>
            ...
            <div className="mt-24 grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
              <div className="lg:col-span-2 space-y-10">
                <div className="p-10 bg-card rounded-[2rem] border border-border relative overflow-hidden shadow-sm">
                  ...
                  <h3 className="text-xl font-black uppercase font-heading text-foreground mb-6 tracking-tight">Условия акции</h3>
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-4 text-muted-foreground font-medium">
