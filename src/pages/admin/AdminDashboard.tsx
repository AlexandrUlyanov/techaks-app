...
export default function AdminDashboard() {
  ...
  const stats = [
    { name: "Всего товаров", value: products.length, icon: Package, color: "bg-blue-500", trend: "+12%", trendUp: true },
    { name: "Магазинов", value: stores.length, icon: Store, color: "bg-purple-500", trend: "0%", trendUp: true },
    { name: "Заявок (мес)", value: "24", icon: TrendingUp, color: "bg-green-500", trend: "+5%", trendUp: true },
    { name: "Посетителей", value: "1.2k", icon: Users, color: "bg-orange-500", trend: "-2%", trendUp: false },
  ];
