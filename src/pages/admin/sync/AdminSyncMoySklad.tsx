            ...
            <div className="flex flex-col gap-4 rounded-2xl border border-red-100 bg-red-50 px-5 py-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <div className="mt-1 text-sm text-red-700">
                  Удаляет товары, категории, отзывы и остатки. Откат возможен только из backup.
                </div>
              </div>
              <button
                onClick={() => {
                  if (
                    window.confirm(
                      "Вы уверены, что хотите ПОЛНОСТЬЮ очистить каталог? Все товары и категории будут удалены."
                    )
                  ) {
