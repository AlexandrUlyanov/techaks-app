            ...
            <div className="flex flex-col gap-4 rounded-2xl border border-red-100 bg-red-50 px-5 py-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <div className="mt-1 text-sm text-red-700">
                  Удаляет категории, товары, модификации, остатки, поиск, отзывы и товарные строки заказов. Откат возможен только из backup.
                </div>
              </div>
              <button
                onClick={() => {
                  if (
                    window.confirm(
                      "Вы уверены, что хотите ПОЛНОСТЬЮ очистить каталог? Будут удалены категории, товары, модификации, остатки, поиск, отзывы и товарные строки заказов."
                    )
                  ) {
