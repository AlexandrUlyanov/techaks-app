        ...
        {leads.length === 0 ? (
          ...
          leads.map(lead => {
            ...
            return (
              <div
                key={lead.id}
                className={`bg-white border rounded-xl p-6 transition-all ${lead.status === "new" ? "border-[#05C3D4] shadow-sm" : "border-gray-200"}`}
              >
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="relative group">
                        <div
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider cursor-pointer ${status.color}`}
                        >
                          <StatusIcon size={14} />
                          {status.label}
                        </div>
