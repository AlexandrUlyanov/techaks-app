...
export function clearThemeFromElement(element: HTMLElement) {
  const variables = Object.keys(buildThemeCssVariables({
    ...
    colors: {
      ...
      badgeTop: "#000000",
      badgeNew: "#000000",
      badgeDiscount: "#000000",
      badgeExcellent: "#000000",
    },
    radii: { button: 0, card: 0, input: 0, modal: 0, badge: 0 },
    typography: {
      fontFamily: "",
      h1Size: 24,
      h2Size: 24,
    ...
    controls: { buttonHeight: 44, inputHeight: 44, iconButtonSize: 44 },
    effects: { buttonShadow: "none", cardShadow: "none", modalShadow: "none" },
  }));
