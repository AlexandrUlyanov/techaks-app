      ...
      >
        {hasMultipleImages ? (
          <div className="order-2 flex flex-col gap-4 md:order-1 md:gap-3">
            ...
            <div
              ref={thumbsRef}
              className="flex max-h-none flex-row gap-3 overflow-x-auto overflow-y-hidden scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden md:max-h-[444px] md:flex-col md:overflow-x-hidden md:overflow-y-auto md:px-1"
            >
