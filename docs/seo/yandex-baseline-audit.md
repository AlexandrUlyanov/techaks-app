...
- серверная подстановка `title`, `description`, `canonical`, `robots`, `JSON-LD` для:
  ...
  - блога,
  - юридических страниц;
- server-friendly HTML fallback для основного контента ключевых SEO-страниц:
  - серверный `H1`,
  - хлебные крошки,
  - краткое описание страницы,
  - базовые ссылки/факты по категории, бренду, товару, магазинам, акциям и блогу;
...
- при росте SEO-трафика оценить, нужен ли следующий шаг от HTML fallback к полноценному hybrid SSR/prerender;
